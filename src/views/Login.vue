    ...
    <div v-if="showDialog" class="confirmation-dialog">
      <div class="dialog-content" style="overflow-y: auto; max-height: 700px">
        <p>
          ...
          Mobile Banking Application Facility provided by Bhedasgaon Nagari
          Sahakari Pathsanstha Ltd., Bhedasgaon. I confirm to the Society that I
          am the duly Authorized User of the Account. I will be solely
          responsible for protecting any password given by Bhedasgaon Nagari
          Sahakari Pathsanstha Ltd., Bhedasgaon for the use of the facility.
          Bhedasgaon Nagari Sahakari Pathsanstha Ltd., Bhedasgaon will not be
          liable for any unauthorized use of any password(s) given to me as an
          Authorized User or for any fraudulent, duplicate or erroneous
          instructions given by use of the password. If I have reason to believe
          that my Mobile Phone Number is / has been allotted to another person
          and / or there has been an unauthorized transaction in the Account and
          / or my Mobile Phone Number is lost, the Authorized User shall
          immediately inform Bhedasgaon Nagari Sahakari Pathsanstha Ltd.,
          Bhedasgaon under acknowledgement about the same. Bhedasgaon Nagari
          Sahakari Pathsanstha Ltd., Bhedasgaon shall not be responsible for any
          failure to utilize the Facility due to me not being within the
          geographical range within which the Facility is offered, Bhedasgaon
          Nagari Sahakari Pathsanstha Ltd., Bhedasgaon makes no warranty or
          representation of any kind in relation to the system and the network
          or their function or performance or for any loss or damage whenever
          and howsoever suffered or incurred by me or by any person resulting
          from or in connection with the Facility. Bhedasgaon Nagari Sahakari
          Pathsanstha Ltd., Bhedasgaon shall under no circumstance be held
          liable if the Facility is not available or there is any delay in the
          carrying out of the instructions for any reasons whatsoever including
          but not limited to natural calamities, legal restraints, faults in the
          telecommunication network or network failure, or any other reason
          beyond the control of Bhedasgaon Nagari Sahakari Pathsanstha Ltd.,
          Bhedasgaon.
        </p>
